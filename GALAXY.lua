...
GALAXY_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
GALAXY_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
GALAXY_Msg = 'امبروطور التفاعل' 
...
if text == 'معلومات السيرفر 📊' and SudoBot(msg) then 
 local text2 = 'Info Server : \n'
  local GALAXY = database:info()
  text2 = text2..'1 - *Uptime Days* : `'..GALAXY.server.uptime_in_days..'('..GALAXY.server.uptime_in_seconds..' seconds)`\n'
  text2 = text2..'2 - *Commands Processed* : `'..GALAXY.stats.total_commands_processed..'`\n'
  text2 = text2..'3 - *Expired Keys* : `'..GALAXY.stats.expired_keys..'`\n'
  text2 = text2..'4 - *Ops/sec* : `'..GALAXY.stats.instantaneous_ops_per_sec..'`\n'
...
local GALAXY_Msg = database:get(bot_id.."GALAXY:Add:Filter:Rp2"..text..msg.chat_id_)   
if GALAXY_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
🔖↬[The way his inauguration](https://t.me/GALAXY/3)
...
-- vardump(data) 
GALAXYdx(msg.chat_id_, msg.id_, '📤| ايدي المجموعة » ( '..msg.chat_id_..' )\n🚸| عدد الادمنيه » ( *'..data.administrator_count_..' )*\n📛| عدد المحظورين » ( *'..data.kicked_count_..' )*\n🏆| عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
